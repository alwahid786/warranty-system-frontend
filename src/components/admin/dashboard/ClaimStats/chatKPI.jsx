          ...
          <table className="w-full text-sm">
            <thead className="bg-[#F9FAFB] border">
              <tr className="text-gray-500">
                <th className="text-left py-2 px-2 font-semibold text-[13px]">
                  COMPANY
                </th>
                <th className="text-right py-2 px-2 font-semibold text-[13px]">
                  RESPONSE TIME (mins)
                </th>
              </tr>
            </thead>
            <tbody>
              {companies.map((c, idx) => (
                <tr key={idx} className="border-b last:border-none">
                  <td className="py-2 px-5 font-medium text-[13px] text-primary">
                    {c.companyName}
                  </td>
                  <td className="py-2 px-5 text-right font-medium text-[13px] text-primary">
