...
function TermsAndConditions() {
  return (
    <div className="min-h-screen flex flex-col bg-white overflow-hidden">
      {/* Header */}
      <LandingHeader />
      <div className="max-w-4xl mx-auto mt-25 px-6 py-10 text-gray-800 leading-relaxed">
        ...
        <section className="space-y-6">
          ...
          <p>
            ...
            website, member area, blog/discussion features, media galleries, and
            donation tools (together, the “Services”).
          </p>
          <p>
            By using the Services, creating an account, posting in the blog, or
            making a donation, you agree to this TOS and our Privacy Policy (
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            your country). If you’re under 18, you confirm you have
          ...
          <p>
            ...
            violate this TOS or our Community Standards (Section 6).
          </p>
        </section>
        ...
        <section className="space-y-4 mt-8">
          ...
          <p>
            All donations are nonrefundable. By donating, you acknowledge we may
            deploy funds where needs are greatest, including project,
            administrative, and compliance costs.
          </p>
          <ul className="list-disc ml-6 space-y-2">
            <li>
              <strong>Receipts:</strong> You will receive a donation receipt by
              email. You can request a copy later using our Contact page.
            </li>
            <li>
        ...
        <section className="space-y-4 mt-8">
          ...
          <p>
            We use trusted third-party payment processors (e.g., card networks,
            bank transfers, digital wallets). Your payments are subject to their
            terms, privacy practices, and fees. We don’t store full card
            numbers.
          </p>
        </section>
        ...
        <section className="space-y-4 mt-8">
          ...
          <p>
            We publish financial statements, budgets, and impact reports on our
            Transparency page. These may be unaudited, for informational
        ...
        <section className="space-y-4 mt-8">
          ...
          <ul className="list-disc ml-6 space-y-2">
            ...
            <li>
              No exploitative or explicit content, especially involving minors.
            </li>
            <li>
        ...
        <section className="space-y-4 mt-8">
          ...
          <p>
            ...
            with attribution. No scraping, copying, or derivative works without
            written permission.
          </p>
        </section>
        ...
        <section className="space-y-4 mt-8">
          ...
          <p>
            We do not accept or publish images of children taken without proper
            consent. If you upload media, ensure you have obtained all necessary
            permissions and removed identifying metadata. We may edit or decline
            media to protect privacy and safety.
          </p>
        </section>
        ...
        <section className="space-y-4 mt-8">
          ...
          <p>
            ...
            warranties regarding accuracy or suitability. Project timelines and
            outcomes may change due to real-world conditions.
          </p>
        </section>
        ...
        <section className="space-y-4 mt-8">
          ...
          <p>
            ...
            for any claim is limited to the amount you donated in the 12 months
            before the claim.
          </p>
        </section>
        ...
        <section className="space-y-4 mt-8">
          ...
          <p>
            You agree to indemnify and hold harmless Global Learning Bridge, its
            officers, employees, and volunteers from any claims arising from
            your content, use of services, or violation of these terms.
          </p>
        </section>
        ...
        <section className="space-y-4 mt-8">
          ...
          <p>
            ...
            disputes shall be resolved in the courts of Charleston County, South
            Carolina.
          </p>
          <p>
            Optional arbitration clause: Disputes may alternatively be resolved
            via individual binding arbitration under applicable rules, with no
        ...
        <section className="space-y-4 mt-8">
          ...
          <p>
            We may update these Terms from time to time. The update date will be
            posted, and continued use of the Services indicates your acceptance
